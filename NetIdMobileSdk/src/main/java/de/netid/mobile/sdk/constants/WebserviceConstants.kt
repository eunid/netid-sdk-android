...
object WebserviceConstants {
    ...
    const val ACCEPT_HEADER_PERMISSION_WRITE_V2 = "application/vnd.netid.permission-center.netid-subject-status-v2+json"
    ...
    const val PERMISSION_WRITE_QUERY_PARAM_IDENTIFIER_KEY = "q.identifier"
}
