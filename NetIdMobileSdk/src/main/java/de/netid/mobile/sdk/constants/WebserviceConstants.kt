...
object WebserviceConstants {
    ...
    const val ACCEPT_HEADER_PERMISSION_READ_V2 = "application/vnd.netid.permission-center.netid-user-status-v2+json"
    ...
    const val PERMISSION_READ_QUERY_PARAM_IDENTIFIER_KEY = "q.identifier.in"
    const val PERMISSION_READ_QUERY_PARAM_IDENTIFIER_VALUE_TPID = "TPID"
    const val PERMISSION_READ_QUERY_PARAM_IDENTIFIER_VALUE_SYNC_ID = "SYNC_ID"
    const val PERMISSION_READ_QUERY_PARAM_IDENTIFIER_VALUE_ETPID = "ETPID"
